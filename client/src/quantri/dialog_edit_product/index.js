...
export default function FullScreenDialog({ product }) {
    ...
    const [images, setImages] = React.useState(product.img)
    const [name, setName] = React.useState(product.name)
    const [describtion, setDescribtion] = React.useState(product.describtion)
    const [price, setPrice] = React.useState(product.price)
    const [category, setCategory] = React.useState(product.category)
    const [content, setContent] = React.useState(product.detail)
    ...
    return (
        <div>
            <div onClick={handleClickOpen} style={{ marginLeft: "-5px" }}>
                <ButtonEdit />
            </div>
